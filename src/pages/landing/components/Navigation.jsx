    ...
    const navLinks = (
        <ul className='font-medium flex flex-col md:flex-row lg:space-x-8 sm:space-x-4 space-y-2 md:space-y-0 p-4 md:p-0'>
            <li>
                ...
                whileTop={{Scale: 0.9}}
                onClick={(e) => { e.preventDefault(); handleCloseMenu(); handleScrollTo('home')}}
                 href="#home"
            ...
            <li>
                <motion.a whileHover={{Scale: 1.1}}
                whileTop={{Scale: 0.9}}
                onClick={(e) => { e.preventDefault(); handleCloseMenu(); handleScrollTo('services')}}
                href="#services"
            ...
            <li>
                <motion.a whileHover={{Scale: 1.1}}
                whileTop={{Scale: 0.9}}
                onClick={(e) => { e.preventDefault(); handleCloseMenu(); handleScrollTo('about')}}
                href="#about"
            ...
            <li>
                <motion.a whileHover={{Scale: 1.1}}
                whileTop={{Scale: 0.9}}
                onClick={(e) => { e.preventDefault(); handleCloseMenu(); handleScrollTo('blog')}}
                href="#blog"
            ...
            <li>
                <motion.a whileHover={{Scale: 1.1}}
                whileTop={{Scale: 0.9}}
                onClick={(e) => { e.preventDefault(); handleCloseMenu(); handleScrollTo('testimonial')}}
                href="#testimonial"
        ...
        <header className='bg-heroBg text-white py-6 px-4 fixed top-0 left-0 right-0 z-10'>
            <div className='container mx-auto flex justify-between items-center h-full'>
                ...
                <div className='hidden md:block'>
                    <a href="" className='text-white bg-primary hover:bg-primary/90 px-4 py-2 rounded'>Login</a>
                </div>
                <div>
            ...
            {/* mobile navitems */}
            {
                isOpen && (
                    <nav className='absolute top-full left-0 w-full bg-heroBg z-20 md:hidden'>
                        ...
                        <li className='py-2'>
                            <a href="" className='text-white bg-primary hover:bg-primary/90 px-2 py-2 rounded' onClick={(e) => { e.preventDefault(); handleCloseMenu(); }
                            }>Login</a>
                        </li>
                    </nav>
                )
